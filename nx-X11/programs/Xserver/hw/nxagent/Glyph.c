...
#define MAX_8 252
	...
	while (nchars)
	{
	    ...
	    yDst = 0;
            ...
            #ifdef DEBUG
            fprintf(stderr, "nxagentRenderCompositeText8: bytes_to_write %d, bytes_to_clean are %d,"
            ...
            if (bytes_to_clean > 0)
            {
              if (bytes_to_write > 0)
               {
                #ifdef DEBUG
                fprintf(stderr, "nxagentRenderCompositeText8: found %d clean bytes, bytes_to_clean are %d,"
                        " this_chars %d.\n", bytes_to_write, bytes_to_clean, this_chars);
                #endif
              ...
              #ifdef DEBUG
              fprintf(stderr, "nxagentRenderCompositeText8: last 32 bit, bytes_to_write are %d,"
                      " bytes_to_clean are %d, this_chars are %d.\n", bytes_to_write, bytes_to_clean, this_chars);
              #endif

              #ifdef DUMP
              fprintf(stderr, "nxagentRenderCompositeText8: bytes_to_clean %d, ", bytes_to_clean);
              #endif
              ...
              while (bytes_to_clean > 0)
              {
                ...
                #ifdef DEBUG
                fprintf(stderr, "nxagentRenderCompositeText8: Cleaned %d byte.\n", 4 - bytes_to_clean);
                #endif
              }
              ...
              #ifdef DEBUG
              fprintf(stderr, "nxagentRenderCompositeText8: nchars now is %d.\n", nchars);
              #endif
...
#define MAX_16	254
	...
	while (nchars)
	{
	    ...
	    yDst = 0;
            ...
            #ifdef DEBUG
            fprintf(stderr, "nxagentRenderCompositeText16: this_chars %d, this_bytes %d.\n"
            ...
            if (bytes_to_clean > 0)
            {
              ...
              #ifdef DEBUG
              fprintf(stderr, "nxagentRenderCompositeText16: last 32 bit, bytes_to_write are %d,"
              ...
              while (bytes_to_clean > 0)
              {
                ...
                #ifdef DEBUG
                fprintf(stderr, "nxagentRenderCompositeText16: Cleaned %d byte.\n", 4 - bytes_to_clean);
                #endif
              }
              ...
              #ifdef DEBUG
              fprintf(stderr, "nxagentRenderCompositeText16: nchars now is %d.\n", nchars);
              #endif
...
#define MAX_32	254
	...
	while (nchars)
	{
	    ...
	    yDst = 0;
            ...
            #ifdef TEST
            fprintf(stderr, "nxagentRenderCompositeText32: this_chars %d, this_bytes %d.\n",
                    this_chars, this_bytes);
            #endif
